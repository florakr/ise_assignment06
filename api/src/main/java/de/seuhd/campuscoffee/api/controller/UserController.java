    ...
    @Operation(
            ...
            responses = {
                    @ApiResponse(
                            ...
                            description = "The User with provided ID as JSON object."
                    ),
                    @ApiResponse(
                            responseCode = "404",
                            content = @Content(
    ...
    @Operation(
            ...
            responses = {
                    @ApiResponse(
                            ...
                            description = "The User with the provided name as JSON object."
                    ),
                    @ApiResponse(
                            responseCode = "404",
                            content = @Content(
    ...
    @Operation(
            ...
            responses = {
                    @ApiResponse(
                            ...
                            description = "The created User as JSON object."
                    ),
                    @ApiResponse(
                            responseCode = "400",
                            content = @Content(
    ...
    @Operation(
            ...
            responses = {
                    ...
                    @ApiResponse(
                            ...
                            content = @Content(
                                    mediaType = "application/json",
                                    schema = @Schema(implementation = de.seuhd.campuscoffee.api.exceptions.ErrorResponse.class)
                            ),
